...
//         />
//         <span className="text-xl font-semibold">Luga Store</span>
//       </Link>
      ...
      <nav className="flex items-center gap-6 relative">
        ...
        <div className="relative">
          ...
          >
            ...
            {isDropdownOpen && (
              <div className="absolute top-full left-0 w-48 bg-white text-gray-800 rounded-md shadow-lg z-50">
                {categories.map((cat) => (
                  <button
                    key={cat.id}
                    onClick={() => handleCategoryClick(cat.name)}
